...
HD_PWD='/home/wardo/Documents/repos/Pynq/ejemplos/fft/rtl-proj/rtl-proj.runs/design_1_fft_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fft_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fft_0_1.tcl
